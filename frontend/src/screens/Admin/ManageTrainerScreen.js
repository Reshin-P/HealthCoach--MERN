...
import { getAllTrainers } from '../../actions/AdminActions.js';
import HeaderAdmin from '../../components/Admin/HeaderAdmin';
import { blockUnblockTrainers } from '../../actions/AdminActions.js'
...
export default function ManageTrainerScreen() {
    ...
    const unblockHandler = async (id) => {
        dispatch(blockUnblockTrainers(id, "unblock"))
    }
                    ...
                    <Table sx={{ minWidth: 700 }} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="right">streams</StyledTableCell>
                                ...
                                <StyledTableRow key={item.name}>
                                    ...
                                    <StyledTableCell align="right">
                                        <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                                            ...
                                            <Link to={`/trainers/${item._id}`}><Button variant='contained'>View</Button></Link>
                                        </div>
                                    </StyledTableCell>
                                </StyledTableRow>
                            ))}
